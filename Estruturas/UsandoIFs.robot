...
...                 O IF deve ser pouco utilizado, mas tem hora que não tem jeito e precisamos dele mesmo, então vamos ver como é!
...
Rodando uma keyword dada uma condição = false
    Run Keyword If          '${FRUTAS[1]}' == 'maça'            Log     O item número 1 não é maça!!
    Run Keyword Unless      '${FRUTAS[2]}' == 'abacaxi'         Log     O item número 2 não é uma maça
